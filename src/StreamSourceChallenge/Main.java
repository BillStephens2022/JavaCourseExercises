...
// write 5 different streams (one for each letter of "Bingo") to generate
// and print out all of the Bingo balls.  Each stream should use a different
// methodology to get to the desired result.  Then, concatenate the results
// to get the full set of Bingo balls.
public class Main {
