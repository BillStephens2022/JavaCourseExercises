...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("%-14s %-15s %-8s %s%n", "Value", "Unscaled Value",
                "Scale", "Precision");
        for (var bd : bds) {
            System.out.printf("%-15s %-14s %-8s %d %n", bd, bd.unscaledValue(), bd.scale(), bd.precision());
        }
        ...
        System.out.printf("%-14s %-15s %-8s %s%n", "Value", "Unscaled Value",
                "Scale", "Precision");
        for (var bd : bds) {
            System.out.printf("%-15s %-14s %-8s %d %n",
