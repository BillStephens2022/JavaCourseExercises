package Collections.Games.poker;

import Collections.Games.Card;
...
public class PokerGame {
    ...
    public PokerGame(int playerCount, int cardsInHand) {
        ...
        pokerHands = new ArrayList<PokerHand>(cardsInHand);
    }

    public void startPlay() {
        Collections.shuffle(deck);
        Card.printDeck(deck);
        // creating a random middle of the deck to simulate random cutting of the deck
        int randomMiddle = new Random().nextInt(15, 35);
        // rotating the deck in to simulate cutting deck using the randomMiddle derived above
